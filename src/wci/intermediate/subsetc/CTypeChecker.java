...
public class CTypeChecker
{
    ...
    {
        return (type != null) && (type.baseType() == CPredefined.intType);
    }
    ...
    {
        return (type != null) && (type.baseType() == CPredefined.floatType);
    }
    ...
    {
    	return false;
//        return (type != null) && (type.baseType() == CPredefined.booleanType);
    }
    ...
    {
    	return false;
//        return (type != null) && (type.baseType() == CPredefined.charType);
    }
