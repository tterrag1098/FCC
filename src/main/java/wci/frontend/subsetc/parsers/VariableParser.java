...
public class VariableParser extends StatementParser
{
     ...
     */
    public VariableParser(SubsetCParserTD parent)
    {
        super(parent);
    }

//    private static final EnumSet<SubsetCTokenType> SUBSCRIPT_FIELD_START_SET =
...
//        }
    ...
    private static final EnumSet<SubsetCTokenType> RIGHT_BRACKET_SET =
