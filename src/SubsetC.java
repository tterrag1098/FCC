...
public class SubsetC
{
     ...
     */
    public SubsetC(String operation, String filePath, String flags)
    {
        try {
            ...
            parser = FrontendFactory.createParser("SubsetC", "top-down", source);
    ...
    public static void main(String args[])
    {
        try {
            ...
            if (i < args.length) {
                String path = args[i];
                new SubsetC(operation, path, flags);
            }
            else {
                throw new Exception();
            }
